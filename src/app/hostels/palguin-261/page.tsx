...
export default function Palguin261Page() {
  return (
    <div className="min-h-screen py-12 px-4 bg-stone-50">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-gradient-to-br from-blue-600 to-indigo-700 rounded-2xl p-8 text-white mb-8">
          <h1 className="text-3xl md:text-4xl font-bold mb-2">Eitan's Hostel - Palguin</h1>
          <p className="text-xl opacity-90 mb-1">הוסטל איתן - פלגין</p>
          <div className="flex items-center gap-2 mt-4 opacity-90">
            <MapPin className="w-5 h-5" />
            <span>Palguin 261, Pucón, Chile</span>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl overflow-hidden shadow-lg mb-8">
          <img
            src="/hostels/palguin-261.jpeg"
            alt="Eitan's Hostel Palguin 261"
            className="w-full aspect-video object-cover"
            onError={(e) => {
              e.currentTarget.src = 'data:image/svg+xml,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800 450"><rect fill="%23e7e5e4" width="800" height="450"/><text x="50%" y="50%" dominant-baseline="middle" text-anchor="middle" fill="%2378716c" font-size="24">📷 Hostel Palguin 261</text></svg>';
            }}
          />
        </div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div>
              ...
              <p className="text-stone-600 leading-relaxed">
                הוסטל מודרני ומעוצב ברחוב פלגין. 
                מבנה חדש עם כל הנוחויות המודרניות.
                אווירה נעימה ומזמינה למטיילים מכל העולם.
              </p>
            </div>
            <div>
              <h3 className="font-bold text-stone-700 mb-2">🇬🇧 English</h3>
              <p className="text-stone-600 leading-relaxed">
                Modern and designed hostel on Palguin street.
                New building with all modern amenities.
                Pleasant and welcoming atmosphere for travelers from around the world.
              </p>
            </div>
          </div>
        </div>
