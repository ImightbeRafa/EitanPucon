    ...
    <div className="min-h-screen py-12 px-4 bg-stone-50">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-4 mb-10">
          ...
          <div className="bg-green-600 rounded-2xl p-6 text-white">
            ...
            >
              ...
              <span>לחץ כאן להזמנה בהוסטל</span>
            </a>
          </div>
          
          {/* Tours Booking Contact */}
          <div className="bg-blue-600 rounded-2xl p-6 text-white">
            <h2 className="text-xl font-bold mb-1">🎯 הזמנת אטרקציות</h2>
            <a
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8">
          ...
          <ul className="space-y-2 text-stone-600 text-center max-w-md mx-auto">
            <li>• צ׳ק-אין: 14:00</li>
            <li>• צ׳ק-אאוט: 11:00</li>
            <li>• WiFi חינם בכל ההוסטלים</li>
            <li>• מטבח משותף</li>
            <li>• אווירה ישראלית ביתית</li>
            <li>• עזרה בהזמנת אטרקציות</li>
          </ul>
